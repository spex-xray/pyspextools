...
The pyspextools classes can be used in python to do custom file format operations. Below we show examples
of the use of the pyspextools API:
...
The ``user`` and ``musr`` models in SPEX are designed to support custom models from users. Pyspextools contains
a helper class to create these user models. Examples are shown below:

.. toctree::
   :maxdepth: 2

   tutorials/myusermodel
   tutorials/apec
