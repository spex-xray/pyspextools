...
.. WARNING::
   This script only works if `HEASOFT <https://heasarc.nasa.gov/lheasoft/>`_ is installed and sourced in your terminal.
   It needs the python heasp module to read OGIP spectra and responses.
