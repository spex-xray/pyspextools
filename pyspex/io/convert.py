...
def convert_grating_rmf(rmflist,arflist):
    """Convert a list of compatible rmf and arf objects into one res file. This is convenient for combining responses
    that are provided separately, like the Low-Energy Transmission Grating from Chandra."""
